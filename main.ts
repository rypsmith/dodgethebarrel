...
scene.onHitTile(SpriteKindLegacy.Projectile, 9, function (sprite) {
...
scene.onHitTile(SpriteKindLegacy.Food, 9, function (sprite) {
    sprite.destroy()
})
...
mySprite.ay = 500
info.setLife(3)
game.onUpdateInterval(randint(900, 1600), function () {
    randNum = randint(1, 7)
    if (randNum % 7 == 0) {
        ...
        projectile2.vx = randint(-100, -60)
        myTile = scene.getTile(9, 3)
        myTile.place(projectile2)
    } else {
